...
namespace eTickets.Data
{
    public class AppDbInitializer
    {
        ...
        //        if (!await roleManager.RoleExistsAsync(UserRoles.AdminMovie))
        //            await roleManager.CreateAsync(new IdentityRole(UserRoles.AdminMovie));
        //        if (!await roleManager.RoleExistsAsync(UserRoles.UserMovie))
        //            await roleManager.CreateAsync(new IdentityRole(UserRoles.UserMovie));
        ...
        //            await userManager.AddToRoleAsync(newAdminUser, UserRoles.AdminMovie);
        //        }
        ...
        //            await userManager.AddToRoleAsync(newAppUser, UserRoles.UserMovie);
        //        }
        //    }
        //}
    }
